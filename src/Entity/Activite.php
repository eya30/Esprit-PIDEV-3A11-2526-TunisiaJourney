...
=======
    #[Assert\Length(
        min: 5,
        minMessage: "Le type d'activité doit contenir au moins {{ limit }} caractères."
    )]
    #[Assert\Regex(
        pattern: '/^[^0-9]*$/',
        message: "Le type d'activité ne peut pas contenir de chiffres."
    )]
>>>>>>> 1c94a897d2f9442710693a83ad2d8e675fdf34eb
...
=======
    #[Assert\Regex(
        ...
        message: "L'heure de début doit être au format HH:MM (ex: 09:30)."
    )]
    private ?string $HeureDebut = null;
    ...
    #[Assert\Regex(
        pattern: '/^(\d+h(?:\d+min)?|\d+min)$/',
        message: "La durée doit être au format XhYmin, Xh ou Xmin (ex: 2h30min, 1h, 45min)."
    )]
>>>>>>> 1c94a897d2f9442710693a83ad2d8e675fdf34eb
...
=======
    #[Assert\Length(
        min: 5,
        minMessage: "Le nom de l'animateur doit contenir au moins {{ limit }} caractères."
    )]
    #[Assert\Regex(
        pattern: '/^[^0-9]*$/',
        message: "Le nom de l'animateur ne peut pas contenir de chiffres."
    )]
    private ?string $NomAnimateur = null;
...
=======
    ...
    // ── Getters & Setters avec ? pour accepter null ─────────────────────────
    ...
    // ✅ CORRECTION ICI : accepter ?int
    public function getCapaciteM(): ?int { return $this->CapaciteM; }
    public function setCapaciteM(?int $CapaciteM): static { $this->CapaciteM = $CapaciteM; return $this; }

    // ✅ CORRECTION ICI : accepter ?float
    public function getPrix(): ?float { return $this->Prix; }
    public function setPrix(?float $Prix): static { $this->Prix = $Prix; return $this; }
