...
class Commentaire
{
    ...
    // ✅ FIX : nullable: true pour correspondre à la BDD (DEFAULT NULL)
    ...
    #[ORM\Column(name: 'report_reason', type: 'string', length: 255, nullable: true)]
    ...
    public function getIsReported(): ?bool { return $this->isReported; }
