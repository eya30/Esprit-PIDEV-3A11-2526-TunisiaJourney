...
class Evenement
{
    ...
    #[Assert\Regex(pattern: '/[a-zA-ZÀ-ÿ]/', message: "Le lieu doit contenir au moins une lettre.")]
    #[Assert\Regex(pattern: '/^\d+$/', match: false, message: "Le lieu ne peut pas être uniquement des chiffres.")]
    private string $Lieu = '';
    ...
    #[Assert\Length(min: 8, minMessage: "L'organisateur doit contenir au moins {{ limit }} caractères.")]
    #[Assert\Regex(pattern: '/^[^0-9]*$/', message: "L'organisateur ne peut pas contenir de chiffres.")]
     ...
     */
    #[ORM\OneToMany(mappedBy: 'evenement', targetEntity: Activite::class, cascade: ['persist'], orphanRemoval: true)]
