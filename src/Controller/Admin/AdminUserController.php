...
class AdminUserController extends AbstractController
{
    ...
    public function exportExcel(UserRepository $userRepo): StreamedResponse
    {
        ...
        $headerStyle = [
            ...
            'fill'      => ['fillType' => 'solid', 'startColor' => ['argb' => 'FF93032E']],
            'alignment' => ['horizontal' => 'center', 'vertical' => 'center'],
            'borders'   => ['allBorders' => ['borderStyle' => 'thin', 'color' => ['argb' => 'FFDDDDDD']]],
        ];
        $evenRowStyle = ['fill' => ['fillType' => 'solid', 'startColor' => ['argb' => 'FFFFF9F0']]];
        $oddRowStyle  = ['fill' => ['fillType' => 'solid', 'startColor' => ['argb' => 'FFFFFFFF']]];
